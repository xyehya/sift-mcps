...
> **P4.23 remediation freeze (2026-07-16; SPEC accepted 2026-07-19):** the operator-authority/
> MCP-zero-mutation decision remains binding. Storage-profile and recovery details in this
> pre-remediation ADR are not target authority. The sole behavioral authority is
> `docs/architecture/EVIDENCE-CUSTODY-SPEC.md` (accepted 2026-07-19); this ADR is reconciled
> during the remediation sprint.
