...
| POST | `/api/evidence/chain/verify-hmac` | `post_evidence_chain_verify_hmac` | Full Verify Evidence against Postgres custody authority (legacy compatibility URL) | Session (examiner) + step-up |
