...
review/remediation/land — see `MIGRATION_STATE.md`). Historical landed
candidate/log: do not use this as the next build prompt. Originally **design
detail** for stage **D27a** (`15_backend_tooling_revamp.md`). This
