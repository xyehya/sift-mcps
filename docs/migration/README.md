...
JOB-0, PR01 / Phase ID-1, PR02 / Phase ID-2, D27a, D27b, and PR03A / Batch A are
done. The next recommended run is **Plan-stage PR03B / Batch B** for active-case
DB authority and propagation. Start from
...
and [20_portal_dashboard_inventory.md](20_portal_dashboard_inventory.md). Keep
D22/F-11 (`mcp_backends` control-plane registry), evidence/jobs, OpenSearch-core,
and RAG/skills separate unless a candidate doc explicitly batches them.
