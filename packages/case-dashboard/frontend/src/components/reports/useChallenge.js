...
// ─────────────────────────────────────────────────────────────────────────
// useChallenge — examiner-password re-auth state machine (legacy IA parity).
// openChallenge(title, onConfirm) opens the modal; submit() runs onConfirm with
// { password }, which the endpoint re-verifies server-side against Supabase
// (B-MVP-017). On success the modal closes; on failure the error surfaces
// in-modal. Confirm stays disabled until a password is entered.
// ─────────────────────────────────────────────────────────────────────────
