...
const SEALED_STATUS = { seal_status: 'sealed', authority: 'db', manifest_version: 3 }
...
describe('B-MVP-048: evidence Unseal operator action', () => {
  ...
  it('does NOT render the Unseal button when the case is not sealed', async () => {
    const unsealedStatus = { seal_status: 'unsealed', authority: 'db' }
