...
def _case_file_structure() -> dict:
    ...
    # Exclude "evidence" from walking, but its files will NOT be counted, so tests expecting evidence count need adjustment or evidence must not be in exclude_dirs.
