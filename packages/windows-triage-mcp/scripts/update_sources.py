    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            if source_key == "lolbas":
                from windows_triage_mcp_mcp.importers import import_lolbas
                ...
                from windows_triage_mcp_mcp.importers import import_loldrivers
                ...
                from windows_triage_mcp_mcp.importers import import_hijacklibs
